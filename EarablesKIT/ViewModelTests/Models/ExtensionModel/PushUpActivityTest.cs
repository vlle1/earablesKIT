...
namespace ViewModelTests.Models.ExtensionModel
{
    public class PushUpActivityTest
    {
        ...
        {
            PushUpActivityThreshold toTest = new PushUpActivityThreshold();
            int lineNr = 0;
            int count = 0;
            toTest.ActivityDone +=
            ...
            string line;
            System.IO.StreamReader file = new System.IO.StreamReader("../../../../ViewModelTests/Models/ExtensionModel/testData10Pushups.csv");
